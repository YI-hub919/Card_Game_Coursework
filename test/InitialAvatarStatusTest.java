...
public class InitialAvatarStatusTest {
    ...
    public void checkInitalized() {
        ...
        initProcessor.processEvent(null, gameState,null);
        ...
        assertEquals("avatar1 X axis", 2, gameState.player1Avatar.getPosition().getTilex());
        assertEquals("avatar1 Y axis", 3, gameState.player1Avatar.getPosition().getTiley());
        assertEquals("avatar2 X axis", 8, gameState.player2Avatar.getPosition().getTilex());
        assertEquals("avatar2 Y axis", 3, gameState.player2Avatar.getPosition().getTiley());
    }
}
